...
python3 collect_data.py --env bandit --envs 10 --H 50 --dim 5 --var 0.3 --cov 0.0 --envs_eval 20
python3 train.py --env bandit --envs 10 --H 50 --dim 5 --var 0.3 --cov 0.0 --lr 0.0001 --layer 4 --head 4 --shuffle --seed 1